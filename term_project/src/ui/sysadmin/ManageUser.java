...
public class ManageUser extends javax.swing.JFrame {
    ...
    public void populateJtable(){
        ...
        ArrayList<C_Users> userList = user.UsersList();
    ...
    private void jButton_INSERT_ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton_INSERT_ActionPerformed
        ...
        if(verifFields())
        {
            ...
            C_Users user = new C_Users(null,uname,pass,null,fname,tel,email,enterprise,organization,role);
            C_Users.insertUser(user);
            populateJtable();
        }
    ...
    private void jButton_UPDATE_ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton_UPDATE_ActionPerformed
        ...
        try{
            ...
            if(verifFields())
            {
                ...
                C_Users user = new C_Users(id,uname,pass,null,fname,tel,email,enterprise,organization,role);
